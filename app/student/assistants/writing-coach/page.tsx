      ...
      <main className="flex-1 ml-64 p-8 overflow-y-auto">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-purple-600">Writing Coach</h1>
              <p className="text-gray-600">Improve your essays, reports, and creative writing</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="mb-6">
              ...
              <select value={gradeLevel} onChange={(e) => setGradeLevel(e.target.value)} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
            ...
            {!gradeLevel ? (
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                {topics.map((topic) => (
                  <button key={topic} onClick={() => setSelectedTopic(topic)} className={`p-4 border-2 rounded-lg text-left transition-all ${selectedTopic === topic ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-gray-300'}`}>
            ...
            {selectedTopic && (
              <button onClick={() => router.push('/student/ai-tutor')} className="w-full mt-6 bg-purple-600 text-white py-3 rounded-lg font-semibold hover:bg-purple-700 transition-colors">
